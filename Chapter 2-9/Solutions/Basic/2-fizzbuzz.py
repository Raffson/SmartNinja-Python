...
for i in range(1, number+1):  # from 1 to number+1 which gives us [1, number]
    ...
    if i % 3 == 0:
        line += "Fizz"  # if divisible by 3 -> add 'Fizz'
    if i % 5 == 0:
        line += "Buzz"  # if divisible by 5 -> add 'Buzz'
    if line == "":
        print(i)  # if 'line' is still empty, implies not divisible by 3 nor by 5
    else:
        print(line)  # otherwise we just print 'line'
