"""
A robust solution for homework 4.3 (11.3)
...
# sort & take the best 3 games, storing it into a separate file called "bext.txt"
score_list = sorted(score_list, key=lambda e: e["attempts"])
with open("best.txt", "w") as bestfile:
    json.dump(score_list[:3], bestfile, indent=4)
